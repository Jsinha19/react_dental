...
export default function Navbar() {
  ...
  return (
    <nav className="bg-black text-white px-6 md:px-16 py-4 flex items-center justify-between relative z-50">
      {/* Left: Logo */}
      <div className="flex items-center"> {/* Removed gap-8 here, as logo is the only element */}
                ...
                {treatments.map((treatment, index) => (
                  ...
                  >
                    <img
                      ...
                      onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = `https://placehold.co/150x220/CCCCCC/000000?text=${encodeURIComponent(treatment)}`; }}
                    />
      ...
      {/* IMP: Ensure this container has items-center */}
      <div className="flex items-center md:gap-4">
        ...
        {/* IMP: Added mr-4 to the hamburger button */}
        <button
          className="md:hidden text-white mr-4" // Added mr-4 here
